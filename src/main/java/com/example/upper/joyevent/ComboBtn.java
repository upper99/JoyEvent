...
public class ComboBtn {
    ...
    //多点click
    ComboBtn(int num,ArrayList<Point> points){
        this.action = GameLayout.ACTION_CLICK;
    ...
    //划屏1
    ComboBtn(String type,Point startPoint,Point endPoint){
    ...
    //划屏2
    ComboBtn(Point startPoint,Point endPoint){
    ...
    public void dump(){
        System.out.println("[COMBO]dump enter...");
        System.out.println("\tName:"+getName());
        System.out.println("\tAction:"+getAction());
        System.out.println("\tType:"+getType());
        System.out.println("[COMBO]dump exit.");
    }
}
